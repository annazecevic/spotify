...
func (p *Publisher) PublishAlbumCreated(event AlbumCreatedEvent) error {
	return p.publish(SubjectAlbumCreated, event)
}

func (p *Publisher) PublishTrackCreated(event TrackCreatedEvent) error {
	return p.publish(SubjectTrackCreated, event)
}

func (p *Publisher) PublishArtistCreated(event ArtistCreatedEvent) error {
