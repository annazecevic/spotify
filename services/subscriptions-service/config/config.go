...
func LoadConfig() *Config {
	return &Config{
		MongoURI:      getEnv("MONGO_URI", "mongodb://subscriptions-mongodb:27017"),
		MongoDatabase: getEnv("MONGO_DATABASE", "spotify_subscriptions"),
		...
		LogFilePath:   getEnv("LOG_FILE_PATH", "/var/log/subscriptions-service/app.log"),
