...
func (p *Publisher) PublishSubscriptionCreated(event SubscriptionCreatedEvent) error {
	return p.publish(SubjectSubscriptionCreated, event)
}

func (p *Publisher) PublishSubscriptionDeleted(event SubscriptionDeletedEvent) error {
	return p.publish(SubjectSubscriptionDeleted, event)
}
